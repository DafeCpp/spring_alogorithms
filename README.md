...
### Можно получить дополнительные баллы, если добавить интересные текстовые задачи. Необходимы текст задачи, решение и тесты. Каждая задача отдельный ПР, получить дополнительные баллы можно только если пулл реквест смержен в основную ветку.

### Можно получить дополнительные баллы, если добавить теорию в папку doc. Делается в отдельном ПР, получить дополнительные баллы можно только если пулл реквест смержен в основную ветку.

### Код должен быть отформатирован clang-format'ом со стилем Google

Чтобы перед каждым коммитом автоматически форматировать только изменённые C++ файлы, один раз выполните: `./setup-git-hooks.sh`
...
Шаблон теста (первый аргумент — имя набора тестов, второй — имя теста):
